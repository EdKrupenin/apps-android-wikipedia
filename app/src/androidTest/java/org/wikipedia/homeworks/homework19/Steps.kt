...
import org.wikipedia.homeworks.homework26.tools.CloseAlertDialogSS
import org.wikipedia.homeworks.homework26.tools.CloseCustomizeYourToolbarSS
import org.wikipedia.homeworks.homework26.tools.ListOfSmartScenario
...
open class Steps<T : Steps<T>>(private val testContext: TestContext<*>) {
    private val listOfSmartScenario = ListOfSmartScenario(
        listOf(
            ...
            CloseAlertDialogSS(testContext),
        )
    )
